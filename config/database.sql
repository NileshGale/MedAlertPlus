...
CREATE TABLE IF NOT EXISTS `appointments` (
  ...
  `proposed_appointment_date` date DEFAULT NULL,
  `proposed_appointment_time` time DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `medicine_reminders` (
  ...
  `email_daily_time` time DEFAULT NULL,
  `last_email_digest_date` date DEFAULT NULL,
